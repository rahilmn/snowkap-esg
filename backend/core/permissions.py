...
DESIGNATION_ROLE_MAP: dict[str, str] = {
    ...
    "cto": Role.EXECUTIVE,
    "coo": Role.EXECUTIVE,
    "managing director": Role.EXECUTIVE,
    "head of sustainability": Role.SUSTAINABILITY_MANAGER,
    "sustainability manager": Role.SUSTAINABILITY_MANAGER,
    "sustainability officer": Role.SUSTAINABILITY_MANAGER,
    "chief sustainability officer": Role.SUSTAINABILITY_MANAGER,
    "esg manager": Role.SUSTAINABILITY_MANAGER,
    "esg head": Role.SUSTAINABILITY_MANAGER,
